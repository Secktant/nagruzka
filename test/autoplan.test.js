...
// 50 → 75 → перегруз, нулевой доход, период уже за порогом, «мне должны»
// в периоде, окно из одной даты, долг меньше минимального платежа, остаток
// от деления, пустое окно.
...
describe('autoDistribute — каскад уровней', () => {
  ...
  test('когда под 50% не влезает — поднимаемся до 75%, но не выше', () => {
  ...
  test('не влезает и в 75% — план строится, но level=null и перечислены перегруженные', () => {
